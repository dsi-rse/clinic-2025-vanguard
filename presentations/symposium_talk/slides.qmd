...
<div class="plain-callout">If that structure tracks tumor biology, it might help predict response. That's the biological reason to expect a vessel-based signal, not just a modeling choice.</div>
