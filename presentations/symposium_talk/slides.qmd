...
<p>exams came from patients who achieved a pathologic complete response (pCR): no invasive cancer remained in the breast or nearby lymph nodes at surgery, associated with better long-term outcomes.</p>
:::

::: {.story-card}
<div class="card-kicker">THE QUESTION</div>
<div class="card-icon">Can a GNN help?</div>
<p>Can a GNN use connections within breast vessel networks to improve treatment-response prediction?</p>
:::
:::

<div class="aside-note">A graph neural network, or GNN, learns from both measurements at vessel locations and the connections between them.</div>

<div class="plain-callout">Earlier prediction could guide less intensive therapy for patients likely to achieve pCR and alternative therapy for those unlikely to do so.</div>
...
::: {.result-grid}
::: {.result-card}
![](figures/vessels_normal.png){.nostretch height="320px" fig-align="center"}
...
::: {.result-card .caution}
![](figures/vessels_tumor.png){.nostretch height="320px" fig-align="center"}
...
<div class="plain-callout">Because tumor vessels differ in both structure and blood flow, those patterns may help predict treatment response.</div>
